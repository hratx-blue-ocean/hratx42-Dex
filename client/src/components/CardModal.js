              ...
              <Col xs={8} style={styles.mainContent}>
                ...
                <Row>
                      <Col style={styles.playersStyle}>
                        <select>
                          <option key = {Math.random()}>Miles</option>
                          <option key = {Math.random()}>Michael</option>
                          <option key = {Math.random()}>DJ</option>
                        </select>
                      </Col>
                      <Col style={styles.tagsStyle}>
                        <select>
                          <option key = {Math.random()}>FrontEnd</option>
                          <option key = {Math.random()}>BackEnd</option>
                          <option key = {Math.random()}>Git</option>
                        </select>
                      </Col>
                </Row>
                {/* Text Input Area */}
            ...
            {/* Header Container for effort, impact, title, and exit */}
              <Col xs={4} style={styles.addToCardCol}>
                ...
                <select style={{width:'100%'}}>
                  <option key = {Math.random()}>BackLog</option>
                  <option key = {Math.random()}>In Progress</option>
                  <option key = {Math.random()}>Ready For Review</option>
                  <option key = {Math.random()}>Completed</option>
                </select>
                </Row>
