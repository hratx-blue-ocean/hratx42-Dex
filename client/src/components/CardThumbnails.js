...
export default function CardThumbnails(props) {
  ...
  return (
    <div style = {{width: '150px', height: '150px'}}>
      ...
      <EditCardModal users={props.users} editCard={props.editCard} key={Math.random()} showMe={show} deckNames={props.deckNames} deckTitle={props.deckTitle} card={props.singleCard} closeModal={handleClose.bind(this)}/>
      <Card onClick={()=> {
        setShow(true)
